...
const Header = () => {
  // State to handle scroll effect and mobile menu open/close
  ...
  // Component for navigation links, handling click to close mobile menu
  const NavLink = ({ title }) => (
    <LinkScroll
          ...
          <div className="max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
            ...
            <nav className="max-lg:relative max-lg:z-2 max-lg:my-auto">
              <ul className="flex max-lg:block max-lg:px-12">
                <li className="nav-li">
                  {/* Navigation links for features and pricing */}
                ...
                <li className="nav-li">
                  {/* Navigation links for FAQ and download sections */}
                  <NavLink title="faq" />
                  <div className="dot" />
